    ...
    return NextResponse.json({
      ...
      currentSubscription: currentSub
        ? {
            ...
            price: currentSub.price || currentSub.plan.price,
            paidAmount: currentSub.paidAmount,
            balanceDue: currentSub.balanceDue,
            hasDebt: currentSub.balanceDue > 0,
            remainingSessions: currentSub.remainingSessions,
            totalSessions: currentSub.totalSessions,
